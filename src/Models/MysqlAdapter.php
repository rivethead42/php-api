...
class MysqlAdapter implements IDbAdapter{
     ...
     * @return int
     */
    public function insert($table, $bind = array()) : int {
     ...
     * @param array $where
     */
    public function update($table, $bind = array(), $where = array()) : void {
        $db = $this->getConnection();
     ...
     * @return array
     */
    public function fetchAll($statement, $bind = array()) : array {
     ...
     * @return array
     */
    public function fetchOne($statement, $bind = array()) : array {
